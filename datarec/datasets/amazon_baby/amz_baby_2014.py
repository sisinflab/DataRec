...
class AMZ_Baby_2014(BaseDataRecBuilder):
    url = 'https://snap.stanford.edu/data/amazon/productGraph/categoryFiles/ratings_Baby.csv'
    data_file_name = os.path.basename(url)
    decompressed_data_file_name = data_file_name
    REQUIRED_FILES = [decompressed_data_file_name]
    CHECKSUM = '716a9237ea99c816b9425e1cc7ddb152'
