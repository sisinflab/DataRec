...
class AmazonBook(DataRec):
    train_url = ('https://raw.githubusercontent.com/huangtinglin/Knowledge_Graph_based_Intent_Network/'
                 'main/data/amazon-book/train.txt')
    test_url = ('https://raw.githubusercontent.com/huangtinglin/Knowledge_Graph_based_Intent_Network/'
                'main/data/amazon-book/test.txt')
