...
from datarec.datasets.download import download_compressed_file, decompress_gz
from datarec.data.format import data_from_inline


class AmazonClothing_V1(DataRec):
    url = 'https://datarepo.eng.ucsd.edu/mcauley_group/data/amazon_2023/benchmark/0core/rating_only/Clothing_Shoes_and_Jewelry.csv.gz'
    ...
    def __init__(self, folder=None):
        ...
        self.path = self.process(file_path)
