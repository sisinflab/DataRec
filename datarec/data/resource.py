    ...
    def load(self, use_cache=True, to_cache=True) -> DataRec:
        ...
        if self.format == 'transactions_tabular':
            ...
            datarec_ = read_transactions_tabular(self.path(), 
                                                ...
                                                encoding=schema.get('encoding', None),
                                                encoding_errors=schema.get('encoding_errors', 'strict'),
                                                quotechar=schema.get('quotechar', '"'),
                                                escapechar=schema.get('escapechar', None),
                                                doublequote=schema.get('doublequote', True),
                                                on_bad_lines=schema.get('on_bad_lines', 'warn'),
