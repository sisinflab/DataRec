...
class LeaveNLast(Splitter):
    ...
    Args:
        test_n (int, optional): Number of last interactions to include in the test set. Defaults to 0.
        validation_n (int, optional): Number of last interactions to include in the validation set. Defaults to 0.
        seed (int, optional): Random seed for reproducibility. Defaults to 42.

    Raises:
        ValueError: If `test_ratio` or `val_ratio` are negative.
    """
